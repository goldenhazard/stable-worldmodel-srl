...
# Vendored: BASE_DIR resolves to .../stable_worldmodel/envs/deformable/
# (4 levels up from this file: sim_env -> sim -> src -> deformable).
    ...
    def add_robot(self):
        if self.obj in ["granular"]:
            ...
            self.robotId = pyflex.loadURDF(
                ...
                os.path.join(BASE_DIR, "src/sim/assets/xarm/xarm6_with_gripper_board.urdf"),
                robot_base_pos,
                robot_base_orn,
                globalScaling=10.0,
            )
            ...
            self.robotId = pyflex.loadURDF(
                self.flex_robot_helper,
                os.path.join(BASE_DIR, "src/sim/assets/xarm/xarm6_with_gripper.urdf"),
                robot_base_pos,
                robot_base_orn,
                globalScaling=10.0,
            )
            ...
            self.robotId = pyflex.loadURDF(
                self.flex_robot_helper,
                os.path.join(BASE_DIR, "src/sim/assets/xarm/xarm6_with_gripper_grasp.urdf"),
                robot_base_pos,
                robot_base_orn,
                globalScaling=10.0,
            )
